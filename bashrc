...
export PS1="\[\e[1;37m\]\u${lineCol}(\[\e[0;36m\]\l${lineCol}:\[\e[0;35m\]\j${lineCol})\[\e[0;32m\]@\[\e[1;32m\]\H${lineCol}[\$(/home/aaron/.batstring)${lineCol}]\[\e[0;34m\]:\[\e[1;34m\]\w${lineCol}\$(if [[ \$gitB != \"\" ]]; then echo \" \[\e[1;105m\]\302\261${lineCol}\"; fi)
