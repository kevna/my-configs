...
if [[ $- == *i* ]]; then
	...
	export PS1="${lineCol}\342\224\214\342\225\274\[\e[1;37m\]\u${lineCol}(\[\e[0;36m\]\l${lineCol}:\[\e[0;95m\]\j${lineCol})\[\e[0;32m\]@\[\e[1;32m\]\H$(if [[ -f ~/.batstring ]]; then echo "${lineCol}[\$(~/.batstring)${lineCol}]"; fi)\[\e[0;34m\]:\[\e[1;34m\]\w${lineCol}\$(if [[ \$gitB != \"\" ]]; then echo \" \[\e[1;44m\]\342\210\223\[\e[0;34m\]\$(echo -n \"\$gitB\" | grep \* | sed s/[^a-z]//g)${lineCol}\"; fi)
