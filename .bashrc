...
export PS1="${lineCol}\342\224\214\342\225\274\[\e[1;37m\]\u${lineCol}(\[\e[0;36m\]\l${lineCol}:\[\e[0;95m\]\j${lineCol})\[\e[0;32m\]@\[\e[1;32m\]\H${lineCol}[\$(/home/aaron/.batstring)${lineCol}]\[\e[0;34m\]:\[\e[1;34m\]\w${lineCol}\$(if [[ \$gitB != \"\" ]]; then echo \" \[\e[1;44m\]\342\210\223\[\e[0;34m\]\$(echo -n \"\$gitB\" | sed s/[^a-z]//g)${lineCol}\"; fi)
\342\224\234\$(if [[ \$errorCode == 0 ]]; then echo \"\[\e[1;32m\]\342\234\223\"; else echo \"\[\e[0;91m\]\$errorCode\"; fi)${lineCol}\342\224\200\!\342\224\200\342\225\274\[\e[m\]"
